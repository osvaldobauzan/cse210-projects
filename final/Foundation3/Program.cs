...
class Program
{
    ...
    {
        Address address = new Address("Avenida de la Universidad", "Cuernavaca", "Morelos", "Mexico");
        ...
        Address addressR = new Address("Izaguirre", "Puebla", "Puebla", "Mexico");
        ...
        Address addressOG = new Address("Teotlixco", "Puebla", "Puebla", "Mexico");
